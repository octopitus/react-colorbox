...
var ImageLoading = (function (_React$Component) {
	...
	function ImageLoading() {
		...
		_get(Object.getPrototypeOf(ImageLoading.prototype), 'constructor', this).apply(this, arguments);
	}
	...
	_createClass(ImageLoading, [{
		...
		value: function componentDidEnter() {
			...
			new _spinJs2['default'](opts).spin(DOM);
			DOM.style.opacity = 1;
		}
	}, {
		...
		value: function render() {
			return _react2['default'].createElement(
				'div',
				{ style: _extends({}, this.styles(), this.props.transition) },
				""
			);
		}
	}]);
